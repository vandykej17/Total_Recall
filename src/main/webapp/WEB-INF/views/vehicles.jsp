<!DOCTYPE html>
<!-- saved from url=(0143)https://servicing.nationwide.com/policyservicing/policyOverview.action?sid=ae47832007a840d8b4327e2d9e26c5e3&pkey=PPNM0064806723&bkey=7271234567 -->
...
<a href="https://servicing.nationwide.com/policyservicing/policyOverview.action?sid=ae47832007a840d8b4327e2d9e26c5e3&amp;pkey=PPNM0064806723&amp;bkey=7271234567#skip-main-content" class="hidden">Skip to main content</a>
<a name="top"></a>
<div class="global-container">
	<div class="outer-container">
		<div id="header">
			...
			<header class="main-header group">
				<a class="icon-sprite mobile-nav-button" id="btnMenu" href="https://servicing.nationwide.com/policyservicing/policyOverview.action?sid=ae47832007a840d8b4327e2d9e26c5e3&amp;pkey=PPNM0064806723&amp;bkey=7271234567#">
				...
				<div class="utility-container">
					<div class="utility-inner-container">
						<a id="btnMobileProfile" class="utility-name" href="https://servicing.nationwide.com/policyservicing/policyOverview.action?sid=ae47832007a840d8b4327e2d9e26c5e3&amp;pkey=PPNM0064806723&amp;bkey=7271234567#">
						...
						<div class="utility-panel-container--mobile">
							<div class="utility-panel--mobile" id="profilePanelMobile">
								...
								<div class="utility-link--profile group">
									<a id="btnProfile" class="utility-link" href="https://servicing.nationwide.com/policyservicing/policyOverview.action?sid=ae47832007a840d8b4327e2d9e26c5e3&amp;pkey=PPNM0064806723&amp;bkey=7271234567#">Profile
										<div class="hidden">click here to open or close a menu containing profile information</div>
			...
			<div class="inner-container group" id="skip-main-content" role="main">
				...
				<div class="landing-content">
					<div id="recalls" class="nav-options-container hidden">
						<div class="nav-options-container__header-container">
							<div class="header-container__heading">
								<h2 class="before-sprite header-icon__policy">Your Recalls</h2>
					...
					<div class="nav-options-container">
						<div class="nav-options-container__header-container">
							<div class="header-container__heading">
								<h2 class="before-sprite header-icon__policy"><a href="https://servicing.nationwide.com/policyservicing/policyOverview.action?sid=ae47832007a840d8b4327e2d9e26c5e3&amp;pkey=PPNM0064806723&amp;bkey=7271234567#" onclick="callCoverageClickOnPolicyEBI(&#39;false&#39;); callEditCoveragesQuote(&#39;false&#39;);">Your Policy</a></h2>
								<span class="header-container__description"></span>
							</div>
						</div>
						<div class="clear"></div>
						<div class="nav-options-container__content group">
							...
							<div class="policy-content__right">
								<div class="policy-content-right__col">
									<a href="https://servicing.nationwide.com/policyservicing/policyOverview.action?sid=ae47832007a840d8b4327e2d9e26c5e3&amp;pkey=PPNM0064806723&amp;bkey=7271234567#" onclick="callCoverageClickOnPolicyEBI(&#39;false&#39;); callEditCoveragesQuote(&#39;false&#39;)" class="policy-content__container group">
					...
					<div class="nav-options-container">
						...
						<div class="nav-options-container__header-container nav-options-container__header-container--promo group">
							<div class="header-container__heading">
								<h2 class="before-sprite header-icon__id"><a href="https://servicing.nationwide.com/policyservicing/documentSummary.action?pkey=PPNM0064806723&amp;isFromOriginalRequest=true&amp;bkey=7271234567" onclick="callPolicyOverviewButtonClickEBI(&#39;IDCardsLink&#39;);">ID Cards &amp; Documents</a></h2>
							</div>
						</div>
	...
	<nav id="mobile-navigation-auto" class="mobile-navigation" role="navigation">
		...
		<ul class="secondary-navigation__contact">
			<li><a name="mobile_policyOverview" href="javascript:ctmNavigationWithinApplication(&#39;policyOverview.action?pkey=PPNM0064806723&amp;bkey=7271234567&#39;)">Auto Policy</a></li>
			...
			<li><a name="mobile_idCardsDoc" href="javascript:ctmNavigationWithinApplication(&#39;documentSummary.action?pkey=PPNM0064806723&amp;isFromOriginalRequest=true&#39;)">ID cards &amp; Docs</a></li>
			...
			<li>
				...
				<a name="mobile_claims" href="https://claimsselfservice.nationwide.com/claims/index.html?pkey=PPNM0064806723&amp;NWIESESSION=AAAAAgABAFAb%2B4xj23Kkl65Zomm0ihKCjWg8jX4Ec4tQHBGpEyfUikoN5pI1N6dHjNqasieuF6iw9fsag%2BCrgAUUOVZrcMnt6CPxni%2FjrvIBtY8Ol2tmjA%3D%3D&amp;destinationPageName=claims-list#/redirect">Claims</a>
...
<a id="oo_tab" class="oo_tab_right" href="https://servicing.nationwide.com/policyservicing/policyOverview.action?sid=ae47832007a840d8b4327e2d9e26c5e3&amp;pkey=PPNM0064806723&amp;bkey=7271234567#" role="complementary">Feedback<span class="screen_reader"> Will open a new window</span></a>
<div class="gcb-startBtnsContainer"></div>

<script>
	var policyNumber = $('#polNum').text();
	var numRecalls = 0;
	...
	function acknowledgeRecall(vehicleRecallId) {
		$.ajax({
			...
			dataType: 'json',
			success: function (data) {
				$('#recallDiv' + vehicleRecallId).remove();
				acknowledgedRecalls++;
			}
		});
