...
(function () {
   ...
   if (TLT && !window.TLT) {
    ...
    tltConfig={
        ...
        services: {
            queue: {
                ...
                queues: [
                    {
                        qid: "DEFAULT",
                        //endpoint: "http://cvms1220.nwie.net/tealeaf/TealeafTarget.jsp", --commented out for integrating inside cam
                        endpoint: "/myaccount/tealeafTarget.jsp",
                        maxEvents: 25,
						...
						serializer: "json",
						//crossDomainEnabled: true, --commented out for integrating inside cam
                ...
                privacy: [
                    {
                        targets: [
                            ...
                            "input[type=password]",
							"input[data-tl-id=signin-password-input]"
                        ],
                        "maskType": 3
                    },
					{
                        targets: [
						"input[type=password]", 
						//{ id: "data-tl-id=COAC3PayCCSecCodeInp1", idType: -3 },
						"input[data-tl-id=gif_card_pin]"],
                        maskType: 4,
					...
					{
                        targets: ["input[data-tl-id=COAC3PayCardNumber]", 
						"input[data-tl-id^=COAC3PayCardNumber]",
						"input[data-tl-id=number]"],
                        maskType: 4,
                        maskFunction: function(value) {
                            return value && value.length ? Array(value.length - 3).join("~") + value.substr(value.length - 4, 4) : void 0;
                        }
                    },
					{
                        ...
                        maskType: 4,
                        maskFunction: function(value) {
                            return value.substr(0, 6) + Array(value.length - 9).join("~") + value.substr(value.length - 4, 4);
                        }
                    }
                ]
            },
            ...
            domCapture: {
                ...
                options: {
                    ...
                    maxLength: 9000000,      // If this threshold is exceeded, the snapshot will not be sent
       ...
       // tltConfig.modules.replay.domCapture.enabled = true;
		//}

    };
	// This IF statement is so you could select certain URLs to do DOM capture replay
	/*		if (window.location.pathname.indexOf("checkout") > -1 ) {
			tltConfig.modules.replay.domCapture.enabled = true;
		}
	*/
    ...
    if (typeof window.TLT !== "undefined" && typeof window.TLT.isInitialized === "function" && !(TLT.isInitialized()) && typeof tltConfig === "object") {
